...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        guacNotes.setNotesBody("For a very quick guacamole just take a 1/4 cup of salsa and mix it in with your mashed avocados.\n" +
        ...
        tacoNotes.setNotesBody("We have a family motto and it is this: Everything goes better in a tortilla.\n" +
        ...
        tacosRecipe.addIngredient(new Ingredient("Garlic, Chopped", new BigDecimal(1), cloveUom));
